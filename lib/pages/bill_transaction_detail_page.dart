...
class BillTransactionDetailPage extends StatefulWidget {
  final int id;
  
  
  const BillTransactionDetailPage({super.key,required this.id});

  @override
  State<BillTransactionDetailPage> createState() => _BillTransactionDetailPageState();
}

class _BillTransactionDetailPageState extends State<BillTransactionDetailPage> {
  ...
  void _refreshJournal() async {
    final jrdata = await SQLHelper.getbillTransactionRecord(widget.id);
  ...
  Future<void> _deleteItem(int id) async {
    await SQLHelper.deletebillTransactionRecord(id);
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [                      
                      ...
                      Text("New Reciept Upload (opt.)", style: Theme.of(context).textTheme.titleMedium,),
        ...
        body: SingleChildScrollView(
          child: Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [             
                FinAppTopNavigationBar(greeting: 'Bill Transaction Details', titleGiven: 'Manage/edit the recurring payment'),
                Row(
                  spacing: 10,
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Amount Received', style: Theme.of(context).textTheme.titleMedium,),
                    ListTile(
                ...
                ListTile(
                  ...
                  title: Text( _journal['notes'] ?? '', style: Theme.of(context).textTheme.titleMedium?.copyWith(
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Paid On', style: Theme.of(context).textTheme.titleMedium,),
                    ListTile(
                      shape: RoundedRectangleBorder(
                        side: const BorderSide(
                          width: 1, color: Colors.black54                    
                      ...
                      title: Text(DateFormat('dd-MM-yyyy hh:mm a').format(DateTime.parse(_journal['txndatetime'])), style: Theme.of(context).textTheme.titleMedium,),
                    )
                  ],
                ),
                const SizedBox(height: 10,),

                Text('Due Date Time', style: Theme.of(context).textTheme.titleMedium,),
                ListTile(
                  shape: RoundedRectangleBorder(
                    side: const BorderSide(
                      width: 1, color: Colors.black54                    
                ...
                builder: (context){
                    ...
                    return AlertDialog(                  
                      ...
                      content: const Text('Are you sure you want to remove the Reciept Image?'),
                      actions: [
                        TextButton(
                        ...
                        TextButton(
                          ...
                          if (deleted) {
                            ...
                            await SQLHelper.updateBillImagePath(widget.id, null); // You need to implement this
  ...
  void _onSubmit() async {
    ...
    await SQLHelper.updatebillTransactionRecord(
      widget.id,
